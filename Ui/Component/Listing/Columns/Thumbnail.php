...
namespace Dungbv\Banner\Ui\Component\Listing\Columns;
...
{
    const DIRECTORY_IMAGE = 'banner/images/';
    ...
    public function prepareDataSource(array $dataSource)
    {
        if (isset($dataSource['data']['items'])) {
            ...
            foreach ($dataSource['data']['items'] as & $item) {
                ...
                $item[$fieldName . '_link']     = $this->_urlBuilder->getUrl('banner/index/edit', ['id' => $item['id']]);
